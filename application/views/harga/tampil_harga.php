<div class="page-heading">
    ...
    <a href="<?php echo base_url("harga/tambah"); ?>" class="btn icon icon-left btn-primary"><i data-feather="edit"></i>
        Tambah Harga</a>
    <section class="section" style="margin-top:20px;">
        <div class="card">
            <div class="card-header">Tabel Data Harga</div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url("harga/hapus/".$h->id_harga); ?>"
