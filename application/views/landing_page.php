...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="assets/landing_assets/favicon.ico" />
    <!-- Bootstrap icons-->
    ...
    <link href="assets/landing_css/styles.css" rel="stylesheet" />
</head>
...
<body>
    ...
    <nav class="navbar navbar-light bg-light static-top">
        <div class="container">
            ...
            <a class="btn btn-primary" href="<?php echo base_url("login"); ?>">Sign Up</a>
        </div>
    </nav>
    <!-- Masthead-->
    ...
    <!-- Core theme JS-->
    <script src="assets/landing_js/scripts.js"></script>
    <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
    <!-- * *                               SB Forms JS                               * *-->
