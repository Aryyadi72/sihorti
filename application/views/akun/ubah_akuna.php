        ...
        <div class="card mt-5">
            ...
            <div class="card-body">
                ...
                <form class="form form-horizontal" method="POST"
                    action="<?php echo base_url('akun/update_data_aksi/' . $akun['id_akun'])?>"
                    enctype="multipart/form-data">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-8 form-group">
                                <input type="hidden" id="first-name" class="form-control" name="id_akun"
                                    value="<?php echo $akun['id_akun']?>" />
                            </div>
                            <div class="col-md-4">
                                <label>Level</label>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <select class="choices form-select" name="id_level">
                                        ...
                                        <option value="1" <?php if ($akun['id_level'] == "1") echo "selected"; ?>>1
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <select class="choices form-select" name="id_pegawai">
                                        ...
                                        <option value="1" <?php if ($akun['id_pegawai'] == "1") echo "selected"; ?>>1
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8 form-group">
                                <input type="text" id="first-name" class="form-control" name="username"
                                    placeholder="Username" value="<?php echo $akun['username']?>" />
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8 form-group">
                                <input type="password" id="first-name" class="form-control" name="password"
                                    placeholder="Password" value="<?php echo $akun['password']?>" />
                            </div>
                        </div>
